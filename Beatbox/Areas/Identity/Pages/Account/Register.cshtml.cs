...
namespace BeatBox.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            _roleManager.CreateAsync(new IdentityRole(SD.Role_User_Shop)).GetAwaiter().GetResult();
            }
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(Input.Role==SD.Role_User_Shop)
                {
